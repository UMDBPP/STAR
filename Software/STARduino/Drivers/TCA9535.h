...
void write_TCA_register(uint8_t, uint8_t);;

void write_TCA_output_0(uint8_t);
void write_TCA_output_1(uint8_t);

void write_TCA_config_0(uint8_t);
void write_TCA_config_1(uint8_t);
